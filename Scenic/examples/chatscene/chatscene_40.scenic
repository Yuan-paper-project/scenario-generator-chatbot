...
# Description                   #
#################################
description = "The ego vehicle is turning left at an intersection; the adversarial cyclist on the right of the target lane suddenly stops in the middle of the road, obstructing the ego vehicle's path."
...
AdvAgent = new Bicycle at bikeSpawnPt,
    with heading bikeSpawnPt.heading,  # Perpendicular to the road, crossing the street
    with regionContainedIn None,
...
bikeSpawnPt = new OrientedPoint ahead of endLanePt by - OPT_PARAM_LANE_WIDTH
