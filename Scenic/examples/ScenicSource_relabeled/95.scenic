...
description = "Ego vehicle has an other vehicle at the back following it. Both vehicles either goes makes a right or a left turn at 4-way intersection and must suddenly stop to avoid collision when adversary vehicle from lateral lane continues straight."
