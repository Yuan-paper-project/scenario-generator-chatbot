...
# Description                   #
#################################
description = "Ego vehicle moves straight in the at 4-way intersection and must suddenly stop to avoid collision when adversary vehicle from lateral lane goes left."
