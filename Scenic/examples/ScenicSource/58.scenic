...
# Description                   #
#################################
description = "Ego Vehicle waits at 4-way intersection while one of the two adversary vehicles in adjacent lane passes before performing a lane change to bypass a stationary vehicle and get into the line with the two adversary vehicles."
...
# Adversarial object            #
#################################
param ADV2_INIT_DIST = Range(30, 35)

adversary = new Car at advSpawnPt,
	with blueprint MODEL,
	with behavior AdversaryBehavior(advTrajectory)

adversary2 = new Car behind adversary by globalParameters.ADV2_INIT_DIST,
	with blueprint MODEL,
	with behavior AdversaryBehavior(advTrajectory)
