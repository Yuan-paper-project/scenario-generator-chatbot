...
param EGO_SPEED = Range(14, 17) # Approximately 31-38 mph (35 mph is ~15.6 m/s)
...
monitor TrafficLights():
    ...
    while True:
        if withinDistanceToTrafficLight(ego, 100):
            setClosestTrafficLightStatus(ego, "red")  # Ego runs the red light
        if withinDistanceToTrafficLight(adversary, 100):
            setClosestTrafficLightStatus(adversary, "green") # Adversary has a green light
        wait
